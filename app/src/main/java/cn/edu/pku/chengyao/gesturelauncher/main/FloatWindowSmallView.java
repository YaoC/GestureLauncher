...
public class FloatWindowSmallView extends FrameLayout {
    ...
    private void initView() {
        ...
        View floatView = inflater.inflate(R.layout.float_window_small, null);
...
//                    Toast.makeText(getContext(), "this float window is clicked", Toast.LENGTH_SHORT).show();
                    // 弹出手势窗口
                    FloatWindowManager.getInstance().createBigWindow(getContext());
    ...
    private class AnchorAnimRunnable implements Runnable {
        ...
        public void run() {
            ...
            FloatWindowSmallView.this.postDelayed(this, 16);
        }
    }
